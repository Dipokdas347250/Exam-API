  ...
  return (
    <section className='pt-[50px] bg-[#EEEFFB]'>
      <Container>
        <Flex className=" justify-between px-3 ">
          <div className="w-[38%]">
             <img src={hekto} alt="" />
             <div className="flex">
              <input className='w-[60%]  outline-none rounded-lg h-[40px] bg-[#D9D9D9] mt-[50px] pl-2' type="text" placeholder='Enter Email Address' />
          ...
          <div className="w-[20%]">
            <div className="">
              <h2 className='font-Sans font-bold text-[22px] text-[#000] '>Catagories</h2>
              <ul className='mt-[20px] gap-y-8'>
          ...
          <div className="w-[20%]">
          <div className="">
              <h2 className='font-Sans font-bold text-[22px] text-[#000] '>Customer Care</h2>
              <ul className='mt-[20px] gap-y-8'>
          ...
          <div className="w-[20%]">
          <div className="">
              <h2 className='font-Sans font-bold text-[22px] text-[#000] '>Pages</h2>
              <ul className='mt-[20px] gap-y-8'>
      ...
      <div className="py-[10px] bg-[#E7E4F8] flex justify-around">
        <div className="w-[70%]">
          <h4 className='font-Sans font-semibold text-[16px] text-[#0D0E43] ml-[100px] '>©Webecy - All Rights Reserved</h4>
        </div>
        <div className="w-[30%]">
          <div className="flex  items-center text-center gap-4 text-[#0D0E43]">
            <FaFacebookSquare/>
            <FaLinkedin/>
            <FaTwitter/>
          </div>
